  ...
  return (
    <Dialog open onOpenChange={(open) => !open && onCancel()}>
      <DialogContent
        ...
        className="sm:max-w-md max-sm:left-0 max-sm:top-auto max-sm:bottom-[var(--kb-inset,0px)] max-sm:translate-x-0 max-sm:translate-y-0 max-sm:max-w-full max-sm:rounded-t-2xl max-sm:rounded-b-none max-sm:p-4 max-sm:pb-[calc(env(safe-area-inset-bottom,0px)+1rem)] max-sm:data-[state=open]:zoom-in-100 max-sm:data-[state=closed]:zoom-out-100 max-sm:data-[state=open]:slide-in-from-bottom max-sm:data-[state=closed]:slide-out-to-bottom"
      >
        <div
          aria-hidden="true"
