...
- **Aliases** (in `tsconfig.json`, `config/vite.config.ts`, both vitest configs under `config/`): `@/` → `app/`, `@server/`, `@client/`, `@shared/`. Use them in new code.
